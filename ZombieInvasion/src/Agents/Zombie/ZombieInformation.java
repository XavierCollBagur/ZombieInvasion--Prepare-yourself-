 ...
 * @author Xavier
 */
public class ZombieInformation extends BaseInformation{
    //Public Constructors
    public ZombieInformation(double x, double y) {
        super(x, y);
    }
    
    public ZombieInformation(BaseInformation baseInformation) {
